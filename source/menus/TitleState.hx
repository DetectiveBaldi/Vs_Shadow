...
class TitleState extends SteppingState
{
    ...
    override function create():Void
    {
        ...
        sky.frames = FlxAtlasFrames.fromSparrow(AssetMan.graphic(Paths.png("assets/images/menus/TitleState/sky")), Paths.xml("assets/images/menus/TitleState/sky"));
        ...
        grass = new FlxSprite(0.0, 0.0, AssetMan.graphic(Paths.png("assets/images/menus/TitleState/grass")));
        ...
        logo.frames = FlxAtlasFrames.fromSparrow(AssetMan.graphic(Paths.png("assets/images/menus/TitleState/logo")), Paths.xml("assets/images/menus/TitleState/logo"));
        ...
        prompt.frames = FlxAtlasFrames.fromSparrow(AssetMan.graphic(Paths.png("assets/images/menus/TitleState/prompt")), Paths.xml("assets/images/menus/TitleState/prompt"));
        ...
        tune = FlxG.sound.load(AssetMan.sound(#if html5 Paths.mp3 #else Paths.ogg #end ('assets/music/menus/TitleState/tune')), 1.0, true);
    ...
    override function update(elapsed:Float):Void
    {
        ...
        if ((FlxG.keys.justPressed.ENTER || FlxG.keys.justPressed.SPACE) && confirm == null)
        {
            ...
            confirm = FlxG.sound.load(AssetMan.sound(#if html5 Paths.mp3 #else Paths.ogg #end ('assets/sounds/menus/TitleState/confirm'), false));
